...
public class CalendarUtils {
    ...
    public static class TimeZoneUtils {
        ...
        //                    boolean useHomeTZ =
        //                            !TextUtils.equals(value, CalendarCache.TIMEZONE_TYPE_AUTO);
        ...
        //                        getSharedPreferences((Context) cookie, mPrefsName);
        //                // Write the prefs
         ...
         */
        public String formatDateRange(Context context, long startMillis, long endMillis,
                int flags) {
            String date;
            String tz;
            ...
            synchronized (mSB) {
                mSB.setLength(0);
                date = DateUtils.formatDateRange(context, mF, startMillis, endMillis, flags, tz)
                        .toString();
            }
            return date;
        }
        ...
        //    }
            ...
            //        mHandler.startUpdate(mToken, null, CalendarCache.URI, values2, "key=?",
            //                TIMEZONE_INSTANCES_ARGS);
            //    }
            //}
        //}
